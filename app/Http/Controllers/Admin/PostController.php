...
class PostController extends Controller
{
    ...
    public function updatePost($id, Request $request)
    {
        ...
        if ($this->post->update()) {
            ...
            return redirect()->route('admin.posts.posts')->with('success', ['id' => $id, 'msg' => 'Artigo editado com sucesso', 'slug' => $slug]);
        } else {
            session()->flash('fail', 'Ocorreu um erro ao tentar actualizar o artigo');
            return redirect()->route('admin.posts.posts');
        }
    }
}
